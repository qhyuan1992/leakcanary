 ...
 * references
 * but not trigger any heap dump until this test listener runs, otherwise an analysis in progress
 * might prevent this listener from performing its own analysis.
 *
